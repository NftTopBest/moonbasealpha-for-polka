      ...
      <div class="mx-auto mt-6 text-gray-500 prose prose-indigo prose-lg">
        <div v-if="post.isGating">
          <div class="flex mb-10 items-center justify-between">
            <h5>The content is locked, if you have the <a :href="openseaContractLink(post.nftContractAddress)" target="_blank">NFT</a></h5>
            <btn-black :is-loading="isUnlocking" @click="doUnlock">
              Click Here to Unlocked
            </btn-black>
          </div>
          <div class="flex items-center justify-between">
            <h5>Don't have this NFT? </h5>
            <Web3NftBtnMintNFT :address="address" />
          </div>
        </div>
